...
- PR #629 merged the excluded, unwired Storybook design at approved head `a7c88e1e`, but its [Security run 34722432295](https://github.com/open-autonomy-org/open-autonomy/actions/runs/34722432295) failed because Storybook's transitive `@vitest/mocker` is affected by `GHSA-82fw-gwwq-j7x9`. The supply-chain workflow marks dependency changes human-required; a candidate that contains this merge needs a sourced correction and a green Security result.
