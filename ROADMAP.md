...
Status: the 2.8.2 proposal is withdrawn. The `sharp` advisory is remediated, the verified owner's closure of PR #594 publicly affirms accepted ADR 0001 over the superseded runtime proposal, and the operating-state implementation has landed. PR #618 also landed after exact-head review; replacement artifact preparation remains held because reviews requested changes on the remaining owner-authored PR #619–#621 stack and its package/wire shape is not stable.
Dispatch: hold
...
Readiness: pending
Readiness evidence: the previously reviewed feature handoffs and onboarding evidence remain applicable, and `hermes:task/t_71c39b4b` established the superseded 2.8.2/2.4.1 artifact baseline. [PR #506](https://github.com/open-autonomy-org/open-autonomy/pull/506) replaced setup's copied Codex OAuth credential with the installed native runtime, but its signed-in-home activation timed out and its Security check failed because the unchanged lockfile then audited `GHSA-rgj7-g3m4-5g8c`. [PRs #513–#515](https://github.com/open-autonomy-org/open-autonomy/pull/515) added protected credential capture and the unified timeline. [PRs #518–#522](https://github.com/open-autonomy-org/open-autonomy/pull/522) separated the reusable backend, added self-hosting and exercised installed Codex control-plane discovery. [PR #551](https://github.com/open-autonomy-org/open-autonomy/pull/551) pinned `sharp@0.35.4` and resolved the advisory prerequisite. [PR #597](https://github.com/open-autonomy-org/open-autonomy/pull/597) merged the exact-head-approved ADR 0001 host valve/reporter and installed-Codex app-server boundary; the verified owner's later [PR #594 closure](https://github.com/open-autonomy-org/open-autonomy/pull/594#issuecomment-5648467119) publicly affirms that accepted replacement. [PR #611](https://github.com/open-autonomy-org/open-autonomy/pull/611) merged exact-head-approved ADR 0003 and the operating-state wire at kit 2.9.0, SDK 2.5.0 and backend 0.2.0; only its live-run pause window remains to exercise. [PR #618](https://github.com/open-autonomy-org/open-autonomy/pull/618) then landed the independently approved `exhausted` terminology at head `0c34875e`. Reviews [5188001863](https://github.com/open-autonomy-org/open-autonomy/pull/619#pullrequestreview-5188001863) and [5188002392](https://github.com/open-autonomy-org/open-autonomy/pull/620#pullrequestreview-5188002392) require PR #619–#620 to remove/revert the forbidden backend test edit, preserve top-level API error codes in uniform write receipts, supply a sourced ADR and fresh manual product evidence; PR #620 must also correct stale SDK reporting docs and test-running package hooks. [Review 5188006745](https://github.com/open-autonomy-org/open-autonomy/pull/621#pullrequestreview-5188006745) additionally requires crash/lost-ack idempotency for review/handoff updates, corrected wire documentation and manual acceptance/lost-ack/restart-deduplication evidence. No replacement tarballs or fixed candidate exist.
...
- PR #618 landed after exact-head approval in `hermes:task/t_76e970b3`. The remaining verified-owner stack [#619–#621](https://github.com/open-autonomy-org/open-autonomy/pull/621) proposes kit 2.10.0, SDK 3.0.0 and backend 0.3.0 plus material wire/responsibility changes. Reviews requested changes in `hermes:task/t_115575ae` and `hermes:task/t_e93e9c81`; `hermes:task/t_7acecc4b` covers the cumulative top. Until corrected exact heads pass review, those versions and effects are not a candidate.
...
Status: PR #618 landed after exact-head review. Exact-head reviews requested changes on PR #619–#621 for forbidden test changes, missing ADR/manual evidence, incorrect error receipts and non-idempotent review/handoff publication.
Dispatch: hold
