...
Status: the 2.8.2 proposal is withdrawn. The `sharp` advisory is remediated, the verified owner's closure of PR #594 publicly affirms accepted ADR 0001 over the superseded runtime proposal, and the operating-state implementation has landed. PR #618 also landed after exact-head review; replacement artifact preparation remains held while corrected owner-authored PR #624 receives exact-head review and manual evidence, after reviews requested changes on its PR #619–#621 predecessors.
Dispatch: hold
...
Readiness: pending
Readiness evidence: the previously reviewed feature handoffs and onboarding evidence remain applicable, and `hermes:task/t_71c39b4b` established the superseded 2.8.2/2.4.1 artifact baseline. [PR #506](https://github.com/open-autonomy-org/open-autonomy/pull/506) replaced setup's copied Codex OAuth credential with the installed native runtime, but its signed-in-home activation timed out and its Security check failed because the unchanged lockfile then audited `GHSA-rgj7-g3m4-5g8c`. [PRs #513–#515](https://github.com/open-autonomy-org/open-autonomy/pull/515) added protected credential capture and the unified timeline. [PRs #518–#522](https://github.com/open-autonomy-org/open-autonomy/pull/522) separated the reusable backend, added self-hosting and exercised installed Codex control-plane discovery. [PR #551](https://github.com/open-autonomy-org/open-autonomy/pull/551) pinned `sharp@0.35.4` and resolved the advisory prerequisite. [PR #597](https://github.com/open-autonomy-org/open-autonomy/pull/597) merged the exact-head-approved ADR 0001 host valve/reporter and installed-Codex app-server boundary; the verified owner's later [PR #594 closure](https://github.com/open-autonomy-org/open-autonomy/pull/594#issuecomment-5648467119) publicly affirms that accepted replacement. [PR #611](https://github.com/open-autonomy-org/open-autonomy/pull/611) merged exact-head-approved ADR 0003 and the operating-state wire at kit 2.9.0, SDK 2.5.0 and backend 0.2.0; only its live-run pause window remains to exercise. [PR #618](https://github.com/open-autonomy-org/open-autonomy/pull/618) then landed the independently approved `exhausted` terminology at head `0c34875e`. Reviews [5188001863](https://github.com/open-autonomy-org/open-autonomy/pull/619#pullrequestreview-5188001863), [5188002392](https://github.com/open-autonomy-org/open-autonomy/pull/620#pullrequestreview-5188002392) and [5188006745](https://github.com/open-autonomy-org/open-autonomy/pull/621#pullrequestreview-5188006745) require removal of forbidden test changes/hooks, preserved top-level error codes, a sourced ADR, corrected wire docs, idempotent review/handoff publication and fresh manual evidence. Corrected [PR #624](https://github.com/open-autonomy-org/open-autonomy/pull/624) adds proposed ADR 0005 and source changes aimed at those findings, with green Land/Security, but its landing PR contains no manual observations and exact-head review `hermes:task/t_57c269c4` is pending. No replacement tarballs or fixed candidate exist.
...
- PR #618 landed after exact-head approval in `hermes:task/t_76e970b3`. The remaining verified-owner changes propose kit 2.10.0, SDK 3.0.0 and backend 0.3.0 plus material wire/responsibility changes. Reviews requested changes on PR #619–#621 in `hermes:task/t_115575ae`, `hermes:task/t_e93e9c81` and `hermes:task/t_7acecc4b`; corrected PR #624 is in `hermes:task/t_57c269c4`. Until a corrected exact head passes review and merges, those versions and effects are not a candidate.
...
Status: PR #618 landed after exact-head review. Exact-head reviews requested changes on PR #619–#621 for forbidden test changes, missing ADR/manual evidence, incorrect error receipts and non-idempotent review/handoff publication. Corrected PR #624 adds proposed ADR 0005 and source fixes; its exact-head review and required fresh manual evidence are pending.
Dispatch: hold

Source: signed owner commits at [PR #618](https://github.com/open-autonomy-org/open-autonomy/pull/618), [PR #619](https://github.com/open-autonomy-org/open-autonomy/pull/619), [PR #620](https://github.com/open-autonomy-org/open-autonomy/pull/620), [PR #621](https://github.com/open-autonomy-org/open-autonomy/pull/621) and corrected [PR #624](https://github.com/open-autonomy-org/open-autonomy/pull/624); exact-head review scopes `hermes:task/t_76e970b3`, `hermes:task/t_115575ae`, `hermes:task/t_e93e9c81`, `hermes:task/t_7acecc4b` and `hermes:task/t_57c269c4`.
