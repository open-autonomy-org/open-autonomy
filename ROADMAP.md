...
Status: the 2.8.2 proposal is withdrawn. The `sharp` advisory is remediated, the verified owner's closure of PR #594 publicly affirms accepted ADR 0001 over the superseded runtime proposal, and the operating-state implementation has landed. PR #618 also landed after exact-head review; replacement artifact preparation remains held after corrected owner-authored PR #624 received changes requested for idempotency, wire documentation and missing exact-head manual evidence.
Dispatch: hold
