...
const payDomain = [
    ...
    `card=$(curl -sf -X POST http://127.0.0.1:8788/v1/rails/card -H 'authorization: Bearer valve' -H 'content-type: application/json' -d "{\\"usd_cents\\":250,\\"purpose\\":\\"domain todo-cli.example\\",\\"item\\":\\"$dev\\"}") || { echo "PAYMENT_""RAN the card rail refused"; exit 1; }`,
