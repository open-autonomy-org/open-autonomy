...
- The release approval is the gate, not the reply: the owners team's approval of the Release pull request, then its
  merge. PM cites that record, never a chat message. Direction binds once recorded as an issue or comment by the
  verified GitHub account of a member holding `direction`, or as a commit they land.
