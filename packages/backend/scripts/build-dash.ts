#!/usr/bin/env bun
// The dashboard's browser half, built for a deployment's assets: the hydrating bundle, the kit's stylesheet and the
// dashboard's text face (Iosevka Slab, SIL Open Font License; a Latin subset of the release's light and regular).
