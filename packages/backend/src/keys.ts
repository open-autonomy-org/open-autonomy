...
// code. `scopes: ["steer"]` mints an owner-side driver's key, which can push a roadmap, request the operating state, publish
// and withdraw the owner's statements (ADR 0012), and nothing else.
