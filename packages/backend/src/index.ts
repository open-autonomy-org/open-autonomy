...
export { configurePage, pageConfig, Shell, Nav, Avatar, Progress, StatusDot, STATUS, C, coverStyle, goalLine, nameOf, ownerOf, repoUrlOf, purposeSentence, renderDirectory, renderMessage, renderProject, type PageConfig, type ProjectSlots } from './site.tsx';
