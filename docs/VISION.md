...
- **The board is the promise.** What will be built and in what order, filed by the owner. The agent works it top to bottom and records what it finished.
