...
// serves (the kit's rehearsal writes it into the world). The shape is todo-cli's (a worker per task, a reviewer, the
// hourly PM, stateless handlers keyed on the conversation's own text) with this cookbook's own seed tasks and stages.
//
