...
- **What this is.** notes-api, a project that builds itself through Open Autonomy. `docs/VISION.md` is why. `ROADMAP.yml` is what you build next, in order. `hermes/` is you.
