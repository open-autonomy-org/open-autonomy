...
import '../../../packages/backend/node_modules/@volter-ai-dev/supercode-ui/styles.css';
...
const base = (d: Partial<DashData>): DashData => ({ brand: 'acme autonomy', viewer: 'owner', visibility: PRESETS.open, now: NOW, page: 'overview', ...openAutonomy, team: TEAM as never, ...d } as DashData);
