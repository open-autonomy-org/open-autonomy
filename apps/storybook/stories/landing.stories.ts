...
// The landing page: the platform's, for outsiders. One page, no cover, no tabs; the dashboard is a link away. GitHub Sponsors and grant credits only.
...
export const HooklineWithPatrons: S = { args: { ...hookline, patronage: three } };
...
export const NotYetFunded: S = { args: { ...hookline, v: { ...hookline.v, funded: false, granted_in_usd_cents: 0, consumed_usd_cents: 0, balance_usd_cents: 0, runway_days: null, status: 'unfunded' }, sessions: [], daily: [], roadmap: { schema: hookline.roadmap.schema, items: [] } } };
